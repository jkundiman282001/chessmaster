...
- [x] **Phase 2 — Landing Page**: Public marketing page with dark chess theme, hero section, themeable board preview, and authentication CTAs.
- [x] **Phase 3 — Dashboard**: Authenticated player hub, matchmaking triggers (room creation & code joining), profile stats, match history, and leaderboard.
